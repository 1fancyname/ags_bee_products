#18_user_interface_leg_wm_ppp_export.r
...
while (myvar.user_interface_wm_ppp_export_state != "off") {
  ...
  base::print("Legacy PPP Wachsmonitoring export")
  base::print("To stop the user interface, press 'esc'. To exit Legacy PPP Wachsmonitoring export, type 'exit'.")
  base::print("")
  base::print("")
         ...
         "1" = {
           ...
           switch(myvar.usr.chart_type,
                  "ch1" = {
                    ...
                    base::print("DONE")
                    base::print(paste0("The files are located at: ./Grafik/Legacy_Wachsmonitoring_PPP/Substances/"))
                    base::print("%")
                    base::print("%")
                    base::print("%")
                    base::print("%")
                  ...
                  "ch2" = {
                    ...
                    base::print("DONE")
                    base::print(paste0("The files are located at: ./Grafik/Legacy_Wachsmonitoring_PPP/Substance_Comparison/"))
                    base::print("%")
                    base::print("%")
                    base::print("%")
                    base::print("%")
