...
myfun.plot_prevalence_a <- function(fun_year){
  ...
  for (i in seq_along(myvar.unique_locations)) {
    ...
    ggsave(paste0("bb_",myvar.cur_location_short, "_substance_prevalence.jpg"),
           ...
           width = 4000,
           units = "px",
           path = base::paste0("./Grafik/Apistrip/Prevalence/", fun_year,"/"))
  }
  rm(i)
}
...
myfun.plot_substance_gt_lod_a <- function(fun_year, fun_location){
  ...
  for (i in base::seq_along(myvar.tmp1_sub_unique)) {
    ...
    ggsave(paste0(fun_location, "_a_plot_",myvar.tmp1_sub_unique[i] ,"_gt_lod.jpg"),
           ...
           width = 2300,
           units = "px",
           path = base::paste0("./Grafik/Apistrip/Substances/", fun_year,"/", fun_location, "/greater_than_lod/"))
...
myfun.plot_avg_bb <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("bb_location_avg",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
...
myfun.plot_avg_p <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("p_location_avg",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
...
myfun.plot_avg_a <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    ggsave(paste0("bb_location_avg",myvar.tmp_substances[i],"_gt_loq.jpg"),
           ...
           width = 2800,
           units = "px",
           path = paste0("./Grafik/Apistrip/Mean/", fun_year,"/"))
  }
  rm(i)
}
...
myfun.plot_cum_bb <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("bb_location_cum",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
...
myfun.plot_cum_p <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("p_location_cum",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
...
myfun.plot_cum_w <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("w_location_cum",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
...
myfun.plot_cum_a <- function(fun_year){
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    ...
    tbl_tmp_cur_sub %>%
      ...
      scale_x_date(breaks = myvar.tmp_date_breaks,
                   labels = myvar.tmp_dates_labels)
    ggsave(paste0("a_location_cum",myvar.tmp_substances[i],"_gt_loq.jpg"),
           height = 1080,
           width = 2800,
           units = "px",
           path = paste0("./Grafik/Apistrip/Cumulative/", fun_year,"/"))
  }
  rm(i)
}
...
myfun.plot_matrix_avg_comparison <- function(fun_year, fun_location){
  tbl_tmp <- dplyr::filter(tbl_avg_cum_agr, year == fun_year, location_short == fun_location, matrix != "apistrip")
  ...
  for (i in base::seq_along(myvar.tmp_substances)) {
    tbl_tmp_cur_sub <- dplyr::filter(tbl_avg_cum_agr, year == fun_year, location_short == fun_location, matrix != "apistrip",substance == myvar.tmp_substances[i])
    tbl_tmp_cur_sub %>%
...
myfun.export_tbl_matrix_diff <- function(fun_year) {
  ...
  readr::write_excel_csv(tmp_tbl ,
    base::paste0("./Export/Matrix_Comparison/", fun_year, "/matrix_diff.csv"),
    delim = ";"
  )
}
