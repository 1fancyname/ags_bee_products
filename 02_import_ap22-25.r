...
tmp_tbl_params <- dplyr::filter(script_parameters, parameter_name == "myvar.samples_a_sp_sheet")
myvar.samples_a_sp_sheet <- tmp_tbl_params$user_input[1]
...
tmp_tbl_params <- dplyr::filter(script_parameters, parameter_name == "myvar.results_a_sp_sheet")
myvar.results_a_sp_sheet <- tmp_tbl_params$user_input[1]
...
tbl_results_a_sp <- readxl::read_excel(myvar.results_doc, sheet = myvar.results_a_sp_sheet)
...
tbl_samples_a_sp <- readxl::read_excel(myvar.sample_doc, sheet = myvar.samples_a_sp_sheet)
...
rm(myvar.meta_col_sheet, myvar.meta_doc, myvar.meta_exp_sheet,
   ...
   myvar.results_a_sp_sheet, myvar.samples_a_sp_sheet)
